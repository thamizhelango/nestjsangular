...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 9448 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 12624 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 10410 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 10355 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 15561 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 12366 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 19808 };
      jobHistory.job = job;
      const department: IDepartment = { id: 1940 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 6132 };
      jobHistory.employee = employee;
