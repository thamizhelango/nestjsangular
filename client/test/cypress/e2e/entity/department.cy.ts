...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'hourly pension cartwheel' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('gosh crusader');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'gosh crusader');
