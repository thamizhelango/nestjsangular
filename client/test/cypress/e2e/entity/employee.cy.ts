...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Otilia');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Otilia');

      cy.get(`[data-cy="lastName"]`).type('Crist');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Crist');

      cy.get(`[data-cy="email"]`).type('Summer.Shanahan@gmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Summer.Shanahan@gmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('via feminize apud');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'via feminize apud');

      cy.get(`[data-cy="hireDate"]`).type('2024-08-20T11:16');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2024-08-20T11:16');

      cy.get(`[data-cy="salary"]`).type('21410');
      cy.get(`[data-cy="salary"]`).should('have.value', '21410');

      cy.get(`[data-cy="commissionPct"]`).type('17523');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '17523');
