...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Legacy Marketing Orchestrator');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Legacy Marketing Orchestrator');

      cy.get(`[data-cy="minSalary"]`).type('26');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '26');

      cy.get(`[data-cy="maxSalary"]`).type('14958');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '14958');
