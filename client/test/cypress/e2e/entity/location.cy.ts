...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('chairlift');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'chairlift');

      cy.get(`[data-cy="postalCode"]`).type('anchored');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'anchored');

      cy.get(`[data-cy="city"]`).type('Bismarck');
      cy.get(`[data-cy="city"]`).should('have.value', 'Bismarck');

      cy.get(`[data-cy="stateProvince"]`).type('phew bleakly digest');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'phew bleakly digest');
