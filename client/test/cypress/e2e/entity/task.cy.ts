...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('whimsical saxophone consequently');
      cy.get(`[data-cy="title"]`).should('have.value', 'whimsical saxophone consequently');

      cy.get(`[data-cy="description"]`).type('madly righteously because');
      cy.get(`[data-cy="description"]`).should('have.value', 'madly righteously because');
