...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'nestjs';
  ...
  'jhipster.mail.from' = 'nestjs@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'nestjs API';
  'jhipster.swagger.description' = 'nestjs API documentation';
  ...
  'eureka.instance.appname' = 'nestjs';
  'eureka.instance.instanceId' = 'nestjs:${random.value}';
